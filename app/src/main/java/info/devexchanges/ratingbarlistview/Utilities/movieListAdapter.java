...
import info.devexchanges.ratingbarlistview.R;
...
public class movieListAdapter extends ArrayAdapter<Movie> {
    ...
    public movieListAdapter(AppCompatActivity context, int resource, List<Movie> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_movielist, parent, false);
        ...
        holder.gener.setText(getItem(position).getGeners());
...
//    }
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            gener = (TextView) view.findViewById(R.id.gener);
        }
    }
}
